...
export const AddTagModal = ({ onClose }: AddTagProps) => {
...
const { createMutation } = useTagMutations();

const handleCreate = () => {
if (!epc) return setError("Mã EPC là bắt buộc");
createMutation.mutate(
  { epc, name: name || 'Tên thẻ mới', category: category || undefined, location: location || undefined },
  { 
    onSuccess: onClose, 
    onError: (err: any) => setError(err.message || "Lỗi tạo thẻ") 
  }
);
};
