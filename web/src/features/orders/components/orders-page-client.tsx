...
import { Plus, Search, ArchiveX, Loader2, ClipboardList, ArrowRight } from 'lucide-react';
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm text-slate-500 mb-4 flex items-center gap-4 flex-wrap">
                      <span className="flex items-center gap-1">
                        Người tạo: <strong className="text-slate-700">{(order as any).createdBy?.username ?? '—'}</strong>
                      </span>
                      <span className="flex items-center gap-1">
